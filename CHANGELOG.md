...
## Fork Changes (hfujikawa77/claude-code-action@beta)
...
- **Updated Base Action**: Uses `hfujikawa77/claude-code-base-action@beta` which includes OAuth credential handling
